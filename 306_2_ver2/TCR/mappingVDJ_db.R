...
immunecode_uniq_cdr3<-readRDS("./Re_ AGGR run v2 for 306_3 is here/ImmuneCODE_CDR3_all.rds")
epitope_antigen_CDR3_trios_class1<-readRDS("./Re_ AGGR run v2 for 306_3 is here/ImmuneCODE_epitope_antigen_CDR3_class1.rds")
epitope_antigen_CDR3_trios_class2<-readRDS("./Re_ AGGR run v2 for 306_3 is here/ImmuneCODE_epitope_antigen_CDR3_class2.rds")
...
vdjdb_all_scov2<-readRDS("./Re_ AGGR run v2 for 306_3 is here/VDJdb_epitope_antigen_CDR3.rds")
...
library(writexl)
write_xlsx(list(metadata_with_TRA_TRB=df_metadata_final,TRA_abundance_vals=abundance_TRA,TRB_abundance_vals=abundance_TRB),"TCR_VDJDB_TRA_TRB_metadata_abundance_CHI.xlsx")
